#include "MyTrMatrix.h"
#include "math.h"


MyTrMatrix::MyTrMatrix()
{
	rows = 4; cols = 4;
	alloc();
}
...
void MyTrMatrix::InvertInto(MyTrMatrix &A)
{
	double tmp[12]; /* temp array for pairs */
	double src[16], dst[16]; /* array of transpose source matrix */
