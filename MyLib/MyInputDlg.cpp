...
ColorSelIn::ColorSelIn(TypeProp<QColor> *_v, QAbstractButton *_bw, int flags, bool _autoup)
 :WidgetIn(_v, _bw), v(_v), bw(_bw), sw(NULL), autoup(_autoup), withAlpha( (flags & WithAlpha) != 0)
 ,modellessDlg(NULL)
 ,doModal( (flags & DoModal) != 0)
{
